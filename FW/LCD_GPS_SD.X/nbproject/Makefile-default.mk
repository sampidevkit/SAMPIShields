...
FINAL_IMAGE=${DISTDIR}/LCD_GPS_SD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/LCD_GPS_SD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${DISTDIR}/LCD_GPS_SD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/LCD_GPS_SD.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/LCD_GPS_SD.X.${IMAGE_TYPE}.hex"
endif
